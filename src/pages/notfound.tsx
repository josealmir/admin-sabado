            ...
            <Body>
                ...
                <Main>
                    <div className="d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '70vh' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="96" height="96" fill="#dc3545" className="mb-4" viewBox="0 0 16 16" style={{ display: 'block' }}>
                            <g>
                        ...
                        <h1 className="display-4 fw-bold text-danger">Pagina Não Encontrada - 404</h1>
                        <p className="lead mb-4 text-secondary">A página que você procura não foi encontrada.</p>
